...
<main class="write">
    <div class="front_container">
        <div class="write__form">
            <div>
                <h1 class="write__blog">{{__('translations.edit_your_info')}}</h1>
                ...
                <form enctype="multipart/form-data" method="post" action="{{route('front.update_user')}}">
                    ...
                    <div class="mb-3">
                        <label for="formFile" class="form-label mb-2">{{__('translations.edit_your_photo')}}</label>
                        <input name="avatar" class="form-control" type="file" id="formFile" />
                    </div>
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="mb-2">{{__('translations.edit_name')}}</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="mb-2">{{__('translations.edit_email')}}</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="mb-2">{{__('translations.edit_work')}}</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="mb-2">{{__('translations.edit_address')}}</label>
