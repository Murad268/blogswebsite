...
<main class="write">
    <div class="front_container">
        <div class="write__form">
            <div>
                <h1 class="write__blog">change your password</h1>

                <form enctype="multipart/form-data" method="post" action="{{route('front.update_pass')}}">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="mb-2">new password</label>
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="mb-2">reply new password</label>
